 ...
 */
public class ArtifactGraphTest {
  @Test
  public void graphDeps() {
    ...
    ArtifactGraph ag = new ArtifactGraph(a1);
    ag.addLink(a1.getId(), a2.getId(), new ArtifactLink(a1.getVersion(), a2.getVersion(), null, "compile", null));
    ag.addLink(a1.getId(), a3.getId(), new ArtifactLink(a1.getVersion(), a3.getVersion(), null, "compile", null));
    ag.addLink(a3.getId(), a4.getId(), new ArtifactLink(a3.getVersion(), a4.getVersion(), null, "compile", null));

    Dependencies deps = ag.getDependencies(a1);
    ArtifactGroup group = deps.getArtifactGroups().get("compile");
  ...
  public void artifactGraphPaths() {
    ...
    ag.addLink(a1.getId(), a2.getId(), new ArtifactLink(a1.getVersion(), a2.getVersion(), null, "compile", null));
    ag.addLink(a1.getId(), a3.getId(), new ArtifactLink(a1.getVersion(), a3.getVersion(), null, "compile", null));
    ag.addLink(a2.getId(), a4.getId(), new ArtifactLink(a2.getVersion(), a4.getVersion(), null, "compile", null));
    ag.addLink(a3.getId(), a4.getId(), new ArtifactLink(a3.getVersion(), a4.getVersion(), null, "compile", null));
