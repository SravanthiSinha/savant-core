...
public class VersionComparatorRegistry {
  private static final Map<String, VersionComparator> checkers = new HashMap<String, VersionComparator>();
  ...
  /**
   * Adds the given version comparator that will be used to verify compatibility for
   * artifacts who specify the given compatibility type string.
   *
   ...
   * @return The comparator and never null. If no checkers was registered the default checkers is used
   *         and the default checkers is always not null because initially it is the
   *         {@link IdenticalVersionComparator}.
   */
