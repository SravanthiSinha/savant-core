 ...
 * schemes. MAJOR versions are by definition incompatible upgrades of the API;
 * MINOR versions retain source and binary compatibility with older minor versions;
 * PATCH level changes are perfectly compatible, forwards and backwards.
 * </p>
 *
...
public class MinorVersionComparator implements VersionComparator {
   ...
   * @return Null is returned if either of the versions is null or if they are not on the same major
   *         line. Otherwise, this returns the version that has the highest value.
   */
