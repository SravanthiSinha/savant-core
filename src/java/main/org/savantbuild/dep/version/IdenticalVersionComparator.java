...
/**
 * <p>
 * This class is an artifact compatibility checker that verifies that only exact matches
 * for artifacts are acceptable.
 * </p>
 *
...
public class IdenticalVersionComparator implements VersionComparator {
   ...
   * @return Null is returned if the artifacts are not equal. Otherwise the previous version is
   *         returned.
   */
