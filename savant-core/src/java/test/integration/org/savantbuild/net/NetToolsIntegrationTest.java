...
public class NetToolsIntegrationTest {
  ...
  public void downloadToFile() throws Exception {
    File f = NetTools.downloadToFile(new URI("http://savant.inversoft.org/org/junit/junit/4.4/junit-4.4.jar.md5"), null, null, null);
  ...
  public void downloadToFileWithMD5() throws Exception {
    ...
    File f = NetTools.downloadToFile(new URI("http://savant.inversoft.org/org/junit/junit/4.4/junit-4.4.jar"), null, null, md5);
    assertTrue(f.isFile());
  }
  ...
  public void downloadToFileWithMD5Failure() throws Exception {
    ...
    try {
      NetTools.downloadToFile(new URI("http://savant.inversoft.org/org/junit/junit/4.4/junit-4.4.jar"), null, null, md5);
