 ...
 */
@ImplementedBy(DefaultDependencyResolver.class)
public interface DependencyResolver {
   ...
   */
  Map<Artifact, File> resolve(Artifact artifact, Workflow workflow, Set<String> artifactGroupTypes, boolean transitive, DependencyListener... listeners);
   ...
   * @return The Files for each artifact that was resolve and cached locally.
   */
  Map<Artifact, File> resolve(Dependencies dependencies, Workflow workflow, Set<String> artifactGroupTypes, boolean transitive, DependencyListener... listeners);
